...
class TextStatistics:
    ...
    def run(self, fileName: str) -> None:
        """Run through all text statistics collected, line by line. Stores
        all statistics in global variables, then prints those statistics to
        console.

        Args:
            fileName (str): File name of text
            printResults (bool, optional): [description]. Defaults to True.
            Print results of text statistics
        """
        with open(fileName, "r") as file:
            for line in file:
                ...
                self.letterFrequency = self.countLetterFrequency(
                    line, self.letterFrequency
                )
    ...
    def countWordLengths(self, line: str, wordLengths: dict = {}) -> int:
        ...
        Args:
            ...
            If already have a dictionary containing frequency, it can be
            passed in for efficieny. Passing this in would cause a
            threaded process to not be thread safe.
    ...
    def countLetterFrequency(self, line: str, letterFrequency: dict = {}) -> dict:
        ...
        Args:
            ...
            If already have a dictionary containing frequency, it can be
            passed in for efficieny. Passing this in would cause a threaded
            process to not be thread safe.
